            ...
            <div class="container">
                ...
                <div id="navbar" class="navbar-collapse collapse">
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li><a class="page-scroll" href="#features">Empresas</a></li>
                        <li><a class="page-scroll" href="#team">Buscar</a></li>
                        <li><a class="page-scroll" href="#testimonials">Ofertas</a></li>
                        <li><a class="page-scroll" href="#pricing">Subir Curriculo</a></li>
...
<div id="inSlider" class="carousel carousel-fade" data-ride="carousel">
            ...
            <div class="container">
                <div class="carousel-caption">
                    ...
                    <p>
                        ...
                        <a class="caption-link" href="#" role="button">Pagina Web Oficial</a>
                    </p>
                </div>
                <div class="carousel-image wow zoomIn">
                    <img src="img/landing/s.png" alt="laptop"/>
                </div>
            </div>
    ...
    <a class="left carousel-control" href="#inSlider" role="button" data-slide="prev">
        ...
        <span class="sr-only">Anteriol</span>
    </a>
